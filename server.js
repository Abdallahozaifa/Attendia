...
var url = 'mongodb://heroku_6k4cr6pf:2q8nruj6tv8fppn53dn7ut34g7@ds127993.mlab.com:27993/heroku_6k4cr6pf';
...
app.use('/app', express.static('app.html'));
...
app.get('/', function(req, res) {
    ...
    if (md.mobile()) {
        ...
        // User is on browser
        res.redirect('bootstrapsite/site.html')
        // fs.readFile('bootstrapsite/site.html', 'utf8', function(err, data) {
        //     if (!err) res.send(data);
        //     else return console.log(err);
        // });
    }
    ...
    MongoClient.connect(url, function(err, db) {
        ...
        Course.findCourse(db, msg.courseName, function(course) {
            ...
            Course.updateCourse(db, msg.courseName, newUpdatedCrs, function() {
                res.send({
                    response: "Course Message Added Successfully!"
                });
                db.close();
            });
        });
